...
const userNavigation = [{ name: "প্রোফাইল", to: "/profile" },
{ name: "আমার রেসিপি", to: "/myRecipes" },
{ name: "সংরক্ষিত রেসিপি", to: "/savedRecipes" },
];
              ...
              <div className="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
                <div className="flex md:absolute md:left-0 md:inset-y-0 lg:static xl:col-span-2">
                  <div className="flex-shrink-0 flex items-center">
                    <Link to="/" className="font-bangla text-xl  "
                    >
                      বাংলার-রান্নাঘর
                    </Link>
                  </div>
                    ...
                    <div className="w-full">
                      ...
                      <div className="relative">
                        ...
                        <input
                          id="search"
                          name="search"
                          className="block w-full bg-white border  font-bangla border-gray-300 rounded-md py-2 pl-10 pr-3 text-sm placeholder-gray-500 focus:outline-none focus:text-gray-900 focus:placeholder-gray-400 focus:ring-1 custom-placeholder-font focus:ring-teal-500 focus:border-teal-500 sm:text-sm"
                          placeholder="খুজুন"
                          type="search"
                        />
                      </div>
                ...
                <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                  ...
                  <Link
                    to="/about"
                    className="ml-6 font-bangla inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                  >
                    আমাদের সম্পর্কে
                  </Link>
                  {!token && (
                  ...
                  {token && (
                    ...
                    <Link
                      to="/recipe/create"
                      className="ml-6 inline items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                    >
                      <h2> রেসিপি তৈরি করুন +</h2>
                    ...
                    <Menu as="div" className="flex-shrink-0 relative ml-5">
                      <div>
                        <Menu.Button className="bg-white rounded-full flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
                          ...
                          <span className="ml-3 font-bangla font-medium text-gray-700">
                            {user && user.username}
                          </span>
                        </Menu.Button>
                      </div>
