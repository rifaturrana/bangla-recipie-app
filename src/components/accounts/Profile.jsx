              ...
              <div className="flex items-center">
                <label htmlFor="picture" className="relative cursor-pointer">
                  ...
                  <img
                    ...
                    src={picture ? URL.createObjectURL(picture) : (avatar && avatar.avatar ? avatar.avatar : "https://res.cloudinary.com/dmtc1wlgq/image/upload/v1641911896/media/avatar/default_zrdbiq.png")}
                    alt=""
                  />
                  <input
                    id="picture"
