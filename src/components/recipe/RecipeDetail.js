            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
              ...
              <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
                <div className="flex sm:flex-col1">
                  ...
                  {user && user.id === detailRecipe.author && (
                ...
                <div className="mt-3">
                  <h2 className="sr-only">রেসিপির তথ্যাদি</h2>
                ...
                <div className="mt-6">
                  <h3 className="sr-only">বর্ণনা</h3>
                  <div
                ...
                <div className="mt-2 flex sm:flex-col1">
                  <button
                    ...
                    onClick={() =>
                      dispatch(saveRecipe(detailRecipe.id))
                    }
                  >
                    <BookmarkIcon
                      ...
                      aria-hidden="true"
                    />
                    <p className="hidden ml-1 group-hover:block">সংরক্ষণ করুন</p>
                    <span className="ml-2">
                  ...
                  <button
                    type="button"
                    className="group py-3 px-3 rounded-md flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500"
                    onClick={() => dispatch(likeRecipe(detailRecipe.id))}
                  >
                    <HeartIcon
                      className="h-6 w-6 flex-shrink-0"
                      aria-hidden="true"
                    />
                    <p className="hidden ml-1 group-hover:block">লাইক</p>
                    <span className="ml-2">
